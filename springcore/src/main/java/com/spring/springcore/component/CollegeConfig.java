 ...
 *
 *@ComponentScan -->tells spring which package>>>classes it need to scan e.g College etc
 *
 *So spring is going to READ these files...bzc @Configuration used ...earlier we use xml file for Component scanning
 */
